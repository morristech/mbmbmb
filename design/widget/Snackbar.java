...
public final class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    public static Snackbar make(@NonNull View view, @NonNull CharSequence charSequence, int i) {
        ...
        SnackbarContentLayout snackbarContentLayout = (SnackbarContentLayout) LayoutInflater.from(view.getContext()).inflate(C0022R.layout.design_layout_snackbar_include, view, false);
