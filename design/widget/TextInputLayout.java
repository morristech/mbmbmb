...
public class TextInputLayout extends LinearLayout {
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C00571();
        CharSequence error;
        boolean isPasswordToggledVisible;

        /* renamed from: android.support.design.widget.TextInputLayout$SavedState$1 */
        static class C00571 implements ClassLoaderCreator<SavedState> {
            C00571() {
            }
    ...
    public TextInputLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        context = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0022R.styleable.TextInputLayout, i, C0022R.style.Widget_Design_TextInputLayout);
        this.mHintEnabled = context.getBoolean(C0022R.styleable.TextInputLayout_hintEnabled, true);
        setHint(context.getText(C0022R.styleable.TextInputLayout_android_hint));
        this.mHintAnimationEnabled = context.getBoolean(C0022R.styleable.TextInputLayout_hintAnimationEnabled, true);
        if (context.hasValue(C0022R.styleable.TextInputLayout_android_textColorHint) != null) {
            attributeSet = context.getColorStateList(C0022R.styleable.TextInputLayout_android_textColorHint);
            this.mFocusedTextColor = attributeSet;
            this.mDefaultTextColor = attributeSet;
        }
        if (context.getResourceId(C0022R.styleable.TextInputLayout_hintTextAppearance, -1) != -1) {
            setHintTextAppearance(context.getResourceId(C0022R.styleable.TextInputLayout_hintTextAppearance, 0));
        }
        this.mErrorTextAppearance = context.getResourceId(C0022R.styleable.TextInputLayout_errorTextAppearance, 0);
        attributeSet = context.getBoolean(C0022R.styleable.TextInputLayout_errorEnabled, false);
        boolean z = context.getBoolean(C0022R.styleable.TextInputLayout_counterEnabled, false);
        setCounterMaxLength(context.getInt(C0022R.styleable.TextInputLayout_counterMaxLength, -1));
        this.mCounterTextAppearance = context.getResourceId(C0022R.styleable.TextInputLayout_counterTextAppearance, 0);
        this.mCounterOverflowTextAppearance = context.getResourceId(C0022R.styleable.TextInputLayout_counterOverflowTextAppearance, 0);
        this.mPasswordToggleEnabled = context.getBoolean(C0022R.styleable.TextInputLayout_passwordToggleEnabled, false);
        this.mPasswordToggleDrawable = context.getDrawable(C0022R.styleable.TextInputLayout_passwordToggleDrawable);
        this.mPasswordToggleContentDesc = context.getText(C0022R.styleable.TextInputLayout_passwordToggleContentDescription);
        if (context.hasValue(C0022R.styleable.TextInputLayout_passwordToggleTint)) {
            this.mHasPasswordToggleTintList = true;
            this.mPasswordToggleTintList = context.getColorStateList(C0022R.styleable.TextInputLayout_passwordToggleTint);
        }
        if (context.hasValue(C0022R.styleable.TextInputLayout_passwordToggleTintMode)) {
            this.mHasPasswordToggleTintMode = true;
            this.mPasswordToggleTintMode = ViewUtils.parseTintMode(context.getInt(C0022R.styleable.TextInputLayout_passwordToggleTintMode, -1), null);
        }
        context.recycle();
...
*/
    ...
    L_0x0014:
        ...
        r5.mErrorView = r1;
        r1 = r5.mErrorView;
        r2 = android.support.design.C0022R.id.textinput_error;
        r1.setId(r2);
        r1 = r5.mTypeface;
    ...
    L_0x0054:
        r2 = r5.mErrorView;
        r3 = android.support.v7.appcompat.C0248R.style.TextAppearance_AppCompat_Caption;
        android.support.v4.widget.TextViewCompat.setTextAppearance(r2, r3);
        r2 = r5.mErrorView;
        r3 = r5.getContext();
        r4 = android.support.v7.appcompat.C0248R.color.error_color_material;
    ...
    private void setError(@Nullable final CharSequence charSequence, boolean z) {
        ...
        if (this.mErrorShown) {
            ...
            if (z) {
                ...
                this.mErrorView.animate().alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C00532()).start();
            } else {
...
*/
    ...
    L_0x0006:
        ...
        r3.mCounterView = r0;
        r0 = r3.mCounterView;
        r1 = android.support.design.C0022R.id.textinput_counter;
        r0.setId(r1);
        r0 = r3.mTypeface;
    ...
    L_0x0031:
        r0 = r3.mCounterView;
        r1 = android.support.v7.appcompat.C0248R.style.TextAppearance_AppCompat_Caption;
        android.support.v4.widget.TextViewCompat.setTextAppearance(r0, r1);
        r0 = r3.mCounterView;
        r1 = r3.getContext();
        r2 = android.support.v7.appcompat.C0248R.color.error_color_material;
    ...
    void updateCounter(int i) {
        ...
        if (this.mCounterMaxLength == -1) {
            ...
            this.mCounterView.setText(getContext().getString(C0022R.string.character_counter_pattern, new Object[]{Integer.valueOf(i), Integer.valueOf(this.mCounterMaxLength)}));
        }
        ...
        if (this.mEditText != null) {
            ...
            if (shouldShowPasswordIcon()) {
                if (this.mPasswordToggleView == null) {
                    this.mPasswordToggleView = (CheckableImageButton) LayoutInflater.from(getContext()).inflate(C0022R.layout.design_text_input_password_icon, this.mInputFrame, false);
