...
class ShadowDrawableWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWrapper(Context context, Drawable drawable, float f, float f2, float f3) {
        super(drawable);
        this.mShadowStartColor = ContextCompat.getColor(context, C0022R.color.design_fab_shadow_start_color);
        this.mShadowMiddleColor = ContextCompat.getColor(context, C0022R.color.design_fab_shadow_mid_color);
        this.mShadowEndColor = ContextCompat.getColor(context, C0022R.color.design_fab_shadow_end_color);
    ...
    private void drawShadow(Canvas canvas) {
        ...
        float f9 = f5 / ((r0.mRawShadowSize - (r0.mRawShadowSize * 1.0f)) + f5);
    ...
    private void buildShadowCorners() {
        ...
        float f4 = rectF.top;
        paint2.setShader(new LinearGradient(0.0f, f4, 0.0f, rectF2.top, new int[]{r0.mShadowStartColor, r0.mShadowMiddleColor, r0.mShadowEndColor}, new float[]{0.0f, SHADOW_HORIZ_SCALE, 1.0f}, TileMode.CLAMP));
