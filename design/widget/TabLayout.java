...
public class TabLayout extends HorizontalScrollView {
    ...
    class TabView extends LinearLayout {
        ...
        final void update() {
            ...
            if (this.mCustomView == null) {
                if (this.mIconView == null) {
                    ImageView imageView = (ImageView) LayoutInflater.from(getContext()).inflate(C0022R.layout.design_layout_tab_icon, this, false);
                    addView(imageView, 0);
                    this.mIconView = imageView;
                }
                if (this.mTextView == null) {
                    TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(C0022R.layout.design_layout_tab_text, this, false);
                    addView(textView);
    ...
    public TabLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        attributeSet = context.obtainStyledAttributes(attributeSet, C0022R.styleable.TabLayout, i, C0022R.style.Widget_Design_TabLayout);
        this.mTabStrip.setSelectedIndicatorHeight(attributeSet.getDimensionPixelSize(C0022R.styleable.TabLayout_tabIndicatorHeight, 0));
        this.mTabStrip.setSelectedIndicatorColor(attributeSet.getColor(C0022R.styleable.TabLayout_tabIndicatorColor, 0));
        i = attributeSet.getDimensionPixelSize(C0022R.styleable.TabLayout_tabPadding, 0);
        this.mTabPaddingBottom = i;
        this.mTabPaddingEnd = i;
        this.mTabPaddingTop = i;
        this.mTabPaddingStart = i;
        this.mTabPaddingStart = attributeSet.getDimensionPixelSize(C0022R.styleable.TabLayout_tabPaddingStart, this.mTabPaddingStart);
        this.mTabPaddingTop = attributeSet.getDimensionPixelSize(C0022R.styleable.TabLayout_tabPaddingTop, this.mTabPaddingTop);
        this.mTabPaddingEnd = attributeSet.getDimensionPixelSize(C0022R.styleable.TabLayout_tabPaddingEnd, this.mTabPaddingEnd);
        this.mTabPaddingBottom = attributeSet.getDimensionPixelSize(C0022R.styleable.TabLayout_tabPaddingBottom, this.mTabPaddingBottom);
        this.mTabTextAppearance = attributeSet.getResourceId(C0022R.styleable.TabLayout_tabTextAppearance, C0022R.style.TextAppearance_Design_Tab);
        context = context.obtainStyledAttributes(this.mTabTextAppearance, C0248R.styleable.TextAppearance);
        try {
            this.mTabTextSize = (float) context.getDimensionPixelSize(C0248R.styleable.TextAppearance_android_textSize, 0);
            this.mTabTextColors = context.getColorStateList(C0248R.styleable.TextAppearance_android_textColor);
            if (attributeSet.hasValue(C0022R.styleable.TabLayout_tabTextColor) != null) {
                this.mTabTextColors = attributeSet.getColorStateList(C0022R.styleable.TabLayout_tabTextColor);
            }
            if (attributeSet.hasValue(C0022R.styleable.TabLayout_tabSelectedTextColor) != null) {
                this.mTabTextColors = createColorStateList(this.mTabTextColors.getDefaultColor(), attributeSet.getColor(C0022R.styleable.TabLayout_tabSelectedTextColor, 0));
            }
            this.mRequestedTabMinWidth = attributeSet.getDimensionPixelSize(C0022R.styleable.TabLayout_tabMinWidth, -1);
            this.mRequestedTabMaxWidth = attributeSet.getDimensionPixelSize(C0022R.styleable.TabLayout_tabMaxWidth, -1);
            this.mTabBackgroundResId = attributeSet.getResourceId(C0022R.styleable.TabLayout_tabBackground, 0);
            this.mContentInsetStart = attributeSet.getDimensionPixelSize(C0022R.styleable.TabLayout_tabContentStart, 0);
            this.mMode = attributeSet.getInt(C0022R.styleable.TabLayout_tabMode, 1);
            this.mTabGravity = attributeSet.getInt(C0022R.styleable.TabLayout_tabGravity, 0);
            attributeSet.recycle();
            context = getResources();
            this.mTabTextMultiLineSize = (float) context.getDimensionPixelSize(C0022R.dimen.design_tab_text_size_2line);
            this.mScrollableTabMinWidth = context.getDimensionPixelSize(C0022R.dimen.design_tab_scrollable_min_width);
            applyModeAndGravity();
        } finally {
            context.recycle();
        }
