...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0022R.styleable.CoordinatorLayout_Layout);
            this.gravity = obtainStyledAttributes.getInteger(C0022R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = obtainStyledAttributes.getResourceId(C0022R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = obtainStyledAttributes.getInteger(C0022R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = obtainStyledAttributes.getInteger(C0022R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = obtainStyledAttributes.getInt(C0022R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = obtainStyledAttributes.getInt(C0022R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            this.mBehaviorResolved = obtainStyledAttributes.hasValue(C0022R.styleable.CoordinatorLayout_Layout_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attributeSet, obtainStyledAttributes.getString(C0022R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
    ...
    class C06741 implements OnApplyWindowInsetsListener {
        C06741() {
        }
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        static class C00411 implements ClassLoaderCreator<SavedState> {
            C00411() {
            }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        attributeSet = context.obtainStyledAttributes(attributeSet, C0022R.styleable.CoordinatorLayout, i, C0022R.style.Widget_Design_CoordinatorLayout);
        int i2 = 0;
        i = attributeSet.getResourceId(C0022R.styleable.CoordinatorLayout_keylines, 0);
        if (i != 0) {
        ...
        this.mStatusBarBackground = attributeSet.getDrawable(C0022R.styleable.CoordinatorLayout_statusBarBackground);
        ...
        if (VERSION.SDK_INT >= 21) {
            if (ViewCompat.getFitsSystemWindows(this)) {
                if (this.mApplyWindowInsetsListener == null) {
                    this.mApplyWindowInsetsListener = new C06741();
                }
