...
class FloatingActionButtonImpl {
    ...
    class C00443 implements OnPreDrawListener {
        C00443() {
        }
    ...
    CircularBorderDrawable createBorderDrawable(int i, ColorStateList colorStateList) {
        ...
        newCircularDrawable.setGradientColors(ContextCompat.getColor(context, C0022R.color.design_fab_stroke_top_outer_color), ContextCompat.getColor(context, C0022R.color.design_fab_stroke_top_inner_color), ContextCompat.getColor(context, C0022R.color.design_fab_stroke_end_inner_color), ContextCompat.getColor(context, C0022R.color.design_fab_stroke_end_outer_color));
    ...
    private void ensurePreDrawListener() {
        if (this.mPreDrawListener == null) {
            this.mPreDrawListener = new C00443();
        }
    }
