...
public class FloatingActionButton extends VisibilityAwareImageButton {
    ...
    public static class Behavior extends android.support.design.widget.CoordinatorLayout.Behavior<FloatingActionButton> {
        ...
        public Behavior(Context context, AttributeSet attributeSet) {
            ...
            context = context.obtainStyledAttributes(attributeSet, C0022R.styleable.FloatingActionButton_Behavior_Layout);
            this.mAutoHideEnabled = context.getBoolean(C0022R.styleable.FloatingActionButton_Behavior_Layout_behavior_autoHide, true);
            context.recycle();
        }
    ...
    public FloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        context = context.obtainStyledAttributes(attributeSet, C0022R.styleable.FloatingActionButton, i, C0022R.style.Widget_Design_FloatingActionButton);
        this.mBackgroundTint = context.getColorStateList(C0022R.styleable.FloatingActionButton_backgroundTint);
        this.mBackgroundTintMode = ViewUtils.parseTintMode(context.getInt(C0022R.styleable.FloatingActionButton_backgroundTintMode, -1), null);
        this.mRippleColor = context.getColor(C0022R.styleable.FloatingActionButton_rippleColor, 0);
        this.mSize = context.getInt(C0022R.styleable.FloatingActionButton_fabSize, -1);
        this.mBorderWidth = context.getDimensionPixelSize(C0022R.styleable.FloatingActionButton_borderWidth, 0);
        float dimension = context.getDimension(C0022R.styleable.FloatingActionButton_elevation, 0.0f);
        float dimension2 = context.getDimension(C0022R.styleable.FloatingActionButton_pressedTranslationZ, 0.0f);
        this.mCompatPadding = context.getBoolean(C0022R.styleable.FloatingActionButton_useCompatPadding, false);
        context.recycle();
        this.mImageHelper = new AppCompatImageHelper(this);
        this.mImageHelper.loadFromAttributes(attributeSet, i);
        this.mMaxImageSize = (int) getResources().getDimension(C0022R.dimen.design_fab_image_size);
