...
public class BottomSheetBehavior<V extends View> extends Behavior<V> {
    ...
    private final Callback mDragCallback = new C06692();
    boolean mHideable;
    ...
    protected static class SavedState extends AbsSavedState {
        ...
        static class C00371 implements ClassLoaderCreator<SavedState> {
            C00371() {
            }
    ...
    public BottomSheetBehavior(Context context, AttributeSet attributeSet) {
        ...
        attributeSet = context.obtainStyledAttributes(attributeSet, C0022R.styleable.BottomSheetBehavior_Layout);
        TypedValue peekValue = attributeSet.peekValue(C0022R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight);
        if (peekValue == null || peekValue.data != -1) {
            setPeekHeight(attributeSet.getDimensionPixelSize(C0022R.styleable.BottomSheetBehavior_Layout_behavior_peekHeight, -1));
        } else {
            setPeekHeight(peekValue.data);
        }
        setHideable(attributeSet.getBoolean(C0022R.styleable.BottomSheetBehavior_Layout_behavior_hideable, false));
        setSkipCollapsed(attributeSet.getBoolean(C0022R.styleable.BottomSheetBehavior_Layout_behavior_skipCollapsed, false));
    ...
    public boolean onLayoutChild(CoordinatorLayout coordinatorLayout, V v, int i) {
        ...
        if (this.mPeekHeightAuto != 0) {
            if (this.mPeekHeightMin == 0) {
                this.mPeekHeightMin = coordinatorLayout.getResources().getDimensionPixelSize(C0022R.dimen.design_bottom_sheet_peek_height_min);
            }
