...
import android.support.design.C0022R;
...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C00402 implements AnimatorUpdateListener {
        C00402() {
        }
    ...
    public static class LayoutParams extends android.widget.FrameLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            context = context.obtainStyledAttributes(attributeSet, C0022R.styleable.CollapsingToolbarLayout_Layout);
            this.mCollapseMode = context.getInt(C0022R.styleable.CollapsingToolbarLayout_Layout_layout_collapseMode, 0);
            setParallaxMultiplier(context.getFloat(C0022R.styleable.CollapsingToolbarLayout_Layout_layout_collapseParallaxMultiplier, DEFAULT_PARALLAX_MULTIPLIER));
            context.recycle();
        }
    ...
    class C06731 implements OnApplyWindowInsetsListener {
        C06731() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        context = context.obtainStyledAttributes(attributeSet, C0022R.styleable.CollapsingToolbarLayout, i, C0022R.style.Widget_Design_CollapsingToolbar);
        this.mCollapsingTextHelper.setExpandedTextGravity(context.getInt(C0022R.styleable.CollapsingToolbarLayout_expandedTitleGravity, 8388691));
        this.mCollapsingTextHelper.setCollapsedTextGravity(context.getInt(C0022R.styleable.CollapsingToolbarLayout_collapsedTitleGravity, 8388627));
        attributeSet = context.getDimensionPixelSize(C0022R.styleable.CollapsingToolbarLayout_expandedTitleMargin, 0);
        ...
        if (context.hasValue(C0022R.styleable.CollapsingToolbarLayout_expandedTitleMarginStart) != null) {
            this.mExpandedMarginStart = context.getDimensionPixelSize(C0022R.styleable.CollapsingToolbarLayout_expandedTitleMarginStart, 0);
        }
        if (context.hasValue(C0022R.styleable.CollapsingToolbarLayout_expandedTitleMarginEnd) != null) {
            this.mExpandedMarginEnd = context.getDimensionPixelSize(C0022R.styleable.CollapsingToolbarLayout_expandedTitleMarginEnd, 0);
        }
        if (context.hasValue(C0022R.styleable.CollapsingToolbarLayout_expandedTitleMarginTop) != null) {
            this.mExpandedMarginTop = context.getDimensionPixelSize(C0022R.styleable.CollapsingToolbarLayout_expandedTitleMarginTop, 0);
        }
        if (context.hasValue(C0022R.styleable.CollapsingToolbarLayout_expandedTitleMarginBottom) != null) {
            this.mExpandedMarginBottom = context.getDimensionPixelSize(C0022R.styleable.CollapsingToolbarLayout_expandedTitleMarginBottom, 0);
        }
        this.mCollapsingTitleEnabled = context.getBoolean(C0022R.styleable.CollapsingToolbarLayout_titleEnabled, true);
        setTitle(context.getText(C0022R.styleable.CollapsingToolbarLayout_title));
        this.mCollapsingTextHelper.setExpandedTextAppearance(C0022R.style.TextAppearance_Design_CollapsingToolbar_Expanded);
        this.mCollapsingTextHelper.setCollapsedTextAppearance(C0248R.style.TextAppearance_AppCompat_Widget_ActionBar_Title);
        if (context.hasValue(C0022R.styleable.CollapsingToolbarLayout_expandedTitleTextAppearance) != null) {
            this.mCollapsingTextHelper.setExpandedTextAppearance(context.getResourceId(C0022R.styleable.CollapsingToolbarLayout_expandedTitleTextAppearance, 0));
        }
        if (context.hasValue(C0022R.styleable.CollapsingToolbarLayout_collapsedTitleTextAppearance) != null) {
            this.mCollapsingTextHelper.setCollapsedTextAppearance(context.getResourceId(C0022R.styleable.CollapsingToolbarLayout_collapsedTitleTextAppearance, 0));
        }
        this.mScrimVisibleHeightTrigger = context.getDimensionPixelSize(C0022R.styleable.CollapsingToolbarLayout_scrimVisibleHeightTrigger, -1);
        this.mScrimAnimationDuration = (long) context.getInt(C0022R.styleable.CollapsingToolbarLayout_scrimAnimationDuration, 600);
        setContentScrim(context.getDrawable(C0022R.styleable.CollapsingToolbarLayout_contentScrim));
        setStatusBarScrim(context.getDrawable(C0022R.styleable.CollapsingToolbarLayout_statusBarScrim));
        this.mToolbarId = context.getResourceId(C0022R.styleable.CollapsingToolbarLayout_toolbarId, -1);
        context.recycle();
        setWillNotDraw(false);
        ViewCompat.setOnApplyWindowInsetsListener(this, new C06731());
    }
    ...
    static ViewOffsetHelper getViewOffsetHelper(View view) {
        ViewOffsetHelper viewOffsetHelper = (ViewOffsetHelper) view.getTag(C0022R.id.view_offset_helper);
        if (viewOffsetHelper != null) {
            return viewOffsetHelper;
        }
        viewOffsetHelper = new ViewOffsetHelper(view);
        view.setTag(C0022R.id.view_offset_helper, viewOffsetHelper);
        return viewOffsetHelper;
    }
    ...
    private void animateScrim(int i) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.addUpdateListener(new C00402());
