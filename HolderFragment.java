...
public class HolderFragment extends Fragment {
    ...
    static class HolderFragmentManager {
        private ActivityLifecycleCallbacks mActivityCallbacks = new C06521();
        private boolean mActivityCallbacksIsAdded = false;
        private Map<Activity, HolderFragment> mNotCommittedActivityHolders = new HashMap();
        private Map<Fragment, HolderFragment> mNotCommittedFragmentHolders = new HashMap();
        private FragmentLifecycleCallbacks mParentDestroyedCallback = new C06532();

        /* renamed from: android.arch.lifecycle.HolderFragment$HolderFragmentManager$1 */
        class C06521 extends EmptyActivityLifecycleCallbacks {
            C06521() {
            }
        ...
        /* renamed from: android.arch.lifecycle.HolderFragment$HolderFragmentManager$2 */
        class C06532 extends FragmentLifecycleCallbacks {
            C06532() {
            }
            ...
            public void onFragmentDestroyed(FragmentManager fragmentManager, Fragment fragment) {
                ...
                if (((HolderFragment) HolderFragmentManager.this.mNotCommittedFragmentHolders.remove(fragment)) != null) {
                    fragmentManager = HolderFragment.LOG_TAG;
                    StringBuilder stringBuilder = new StringBuilder();
                    stringBuilder.append("Failed to save a ViewModel for ");
                    stringBuilder.append(fragment);
                    Log.e(fragmentManager, stringBuilder.toString());
                }
            }
        }
        ...
        private static HolderFragment findHolderFragment(FragmentManager fragmentManager) {
            ...
            fragmentManager = fragmentManager.findFragmentByTag(HolderFragment.HOLDER_TAG);
