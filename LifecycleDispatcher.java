...
class LifecycleDispatcher {
    ...
    static class DispatcherActivityCallback extends EmptyActivityLifecycleCallbacks {
        ...
        public void onActivitySaveInstanceState(Activity activity, Bundle bundle) {
            if ((activity instanceof FragmentActivity) != null) {
                LifecycleDispatcher.markState((FragmentActivity) activity, (State) State.CREATED);
            }
        }
    }
    ...
    static class FragmentCallback extends FragmentLifecycleCallbacks {
        ...
        public void onFragmentCreated(FragmentManager fragmentManager, Fragment fragment, Bundle bundle) {
            ...
            if ((fragment instanceof LifecycleRegistryOwner) != null && fragment.getChildFragmentManager().findFragmentByTag(LifecycleDispatcher.REPORT_FRAGMENT_TAG) == null) {
    ...
    private static void markState(FragmentManager fragmentManager, State state) {
        FragmentManager<Fragment> fragments = fragmentManager.getFragments();
        if (fragments != null) {
